...
MinimalSurfaceEstimator::MinimalSurfaceEstimator()
{
	...
	omp_set_nested(1);
	omp_set_dynamic(1);
	mInitialContourCalculatorFunc = std::bind(&MinimalSurfaceEstimator::CalculateInitialContourFromPhaseField, *this, _1, _2);
}
...
void MinimalSurfaceEstimator::Calculate(sitk::Image image, Vec3<double> point1, Vec3<double> point2, double beta, double alpha, int maxIterations) {
	...
	sitk::Image initial_contour = sitk::Cast(mInitialContourCalculatorFunc(plane_image_2d, distanceSlice), sitk::sitkUInt8);
